...
KNN_PCA = 40
KNN_K = 40
BLEND = {"nn": 0.3, "lgb": 0.4, "top1": 0.1, "knn": 0.2}
...
def fit_predict_top1(Xtr, Rtr, ltr, Xte, lte):
    ...
    m = lgb.LGBMClassifier(objective="multiclass", n_estimators=LGB_ROUNDS, learning_rate=0.03, num_leaves=15,
...
def fit_predict(Xtr, Rtr, ltr, Xte, lte):
    members = {
        ...
        "top1": fit_predict_top1(Xtr, Rtr, ltr, Xte, lte),
